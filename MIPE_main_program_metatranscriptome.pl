...
#
#
##Output file: inputtaxonomy.silva.wang.taxonomy, lsu_merge_XXXX.silva.wang.taxonomy and directory of result_$$_input
#
####################################################################################################################################
...
system("./mothur \"#classify.seqs(fasta=$lsu_merge_fasta,reference=$lsu_template,taxonomy=$taxo_lsu_ref)\"");
